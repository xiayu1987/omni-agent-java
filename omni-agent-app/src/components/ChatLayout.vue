...
const emit = defineEmits<{ (e: 'addNewSession', id?: string): void }>()
...
chat.on("session", (newSessionId) => {
  if (props.sessionId === newSessionId) return
  emit('addNewSession', newSessionId)
})
